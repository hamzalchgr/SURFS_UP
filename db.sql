...
--    name, position, img_url
-- ) VALUES 
--    ('Made', 'Head surf coach', 'https://framerusercontent.com/images/sCxCatvugRM5WGKt7CAnjKXk.png?scale-down-to=1024&width=800&height=1200'),
--    ('Ayu', 'Camp host', 'https://framerusercontent.com/images/EtfWfKvC6o7GjscdEUpUoR5S0k.png?scale-down-to=1024&width=904&height=1200'),
--    ('Kadek', 'Assistant coach', 'https://framerusercontent.com/images/cgjtY7NC9PIi1GcV0MZf4QP0LNo.png?scale-down-to=1024&width=800&height=1200'),
--    ('Luka', 'Photographer', 'https://framerusercontent.com/images/nBjdvosPcGqjs2x7l7YWRtqbGwU.png?scale-down-to=1024&width=900&height=1200');